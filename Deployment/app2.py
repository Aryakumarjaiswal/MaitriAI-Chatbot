...
from locker import GOOGLE_API_KEY
...
DONOT print any emoji.If your are  asked any question that is not in document  then simple answer "I'm would have to think about it what else i can assist you with?".
.
...
def speech_to_text():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            response_after_speech_to_text=conversational_rag_chain.invoke({"input":text},
            config={ "configurable": {"session_id": "MaitriAI_Test-II"}})["answer"]
